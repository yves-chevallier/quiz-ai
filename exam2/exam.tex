...
% \makeatletter
% % % \qformat{\Hy@raisedlink{\hypertarget{Q\thequestion-anchor}{}}\thequestion. \ }
% % %\def\qformat{\thequestion. \ }
% \qformat{\leavevmode\makebox[0pt][l]{\Hy@raisedlink{\hypertarget{Q\thequestion-anchor}{}}}\thequestion.\ }

% \makeatother
% \makeatletter
% \qformat{\leavevmode\rlap{\hyper@anchorstart{Q\thequestion-anchor}\hyper@anchorend}\thequestion.\ }%
% \makeatother

% \makeatletter
% \AtBeginEnvironment{questions}{%
%   % Préfixer \question une fois que l'env a installé sa version
%   \pretocmd{\question}{%
%     \leavevmode
%     \edef\qnext{\number\numexpr\value{question}+1\relax}%
%     % ancre PDF, largeur nulle, collée au début de la ligne
%     \rlap{\hyper@anchorstart{Q\qnext-anchor}\hyper@anchorend}%
%   }{}{}%
% }
% \makeatother
...
% \makeatletter
% \qformat{%
%   %\leavevmode\rlap{\hyper@anchorstart{Q\thequestion-anchor}\hyper@anchorend}%
%   \thequestion.\ %
% }%
% \makeatother
