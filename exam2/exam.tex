...
\newcommand{\PDFTag}[1]{\leavevmode\smash{\makebox[0pt][l]{\textcolor{white}{#1}}}}

\makeatletter
\AtBeginEnvironment{questions}{%
  \apptocmd{\question}{%
    \edef\qcurr{\number\value{question}}%
    \PDFTag{Q\qcurr-anchor}%
    \zsavepos{Q\qcurr-anchor}%
  }{}{}%
}
\makeatother
...
% Un seul anchor par question (avant \question).
% Comme \question incrémente le compteur en interne, on calcule q_next = value(question)+1
\pretocmd{\question}{%
  \edef\qnext{\number\numexpr\value{question}+1\relax}%
  % Anchor à gauche du début du texte de la question :
  \tikz[remember picture,overlay]%
    \node (Q\qnext-anchor) [opacity=0,inner sep=0pt,anchor=base east]%
      {\textcolor{white}{Q\qnext-anchor}};%
  \xdef\lastq{\qnext}%
}{}{}
\makeatother
